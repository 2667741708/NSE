...
# Additional single-seed noise-rate validation on c201 GPU0.
# Runs CIFAR-10 q=0.5 at eta=0.1/0.2/0.3 with the main NSE script.
...
LOG="${OUT}/_launcher_logs/gpu0_cifar10_$(date +%Y%m%d_%H%M%S).log"
...
run_exp "main/CIFAR10_q050_eta01_seed1" 0.1
run_exp "main/CIFAR10_q050_eta02_seed1" 0.2
run_exp "main/CIFAR10_q050_eta03_seed1" 0.3
